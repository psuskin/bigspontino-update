      ...
      >
        ...
        <motion.div className="mb-12 sm:mb-16" variants={sectionVariants}>
          <div className="bg-gray-50 p-6 sm:p-8 border border-gray-200">
            <motion.h2
              className="text-xl sm:text-2xl font-bold text-secondary mb-6 tracking-tight"
              whileHover={{ x: 5 }}
              transition={{ duration: 0.3 }}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-secondary">
              <div className="space-y-2">
                ...
                <p>{t('privacy.addressLine2')}</p>
              </div>
              <div className="space-y-2">
                <p>
                  {t('privacy.phone')}:{' '}
                  <span className="font-medium">{t('privacy.phoneNumber')}</span>
                </p>
                <p>
                  {t('privacy.email')}:{' '}
                  <span className="font-medium">{t('privacy.emailAddress')}</span>
                </p>
                <p>
                  {t('privacy.website')}:{' '}
                  <span className="font-medium">{t('privacy.websiteUrl')}</span>
                </p>
              </div>
            </div>
          </div>
