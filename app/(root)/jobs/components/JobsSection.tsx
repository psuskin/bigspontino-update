                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <select
                      ...
                      onChange={(e) =>
                        handleSelectChange("phonePrefix", e.target.value)
                      }
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div>
                    ...
                    >
                      ...
                      <option value="server">
                        {t("jobs.form.positions.server")}
                      </option>
                      <option value="bartender">
                        {t("jobs.form.positions.bartender")}
                      </option>
                      <option value="kitchen">
                        {t("jobs.form.positions.kitchen")}
                      </option>
                      <option value="host">
                        {t("jobs.form.positions.host")}
                      </option>
                      <option value="other">
                        {t("jobs.form.positions.other")}
                      </option>
                    </select>
                  </div>
                  <div>
                    ...
                    >
                      <option value="">{t("jobs.form.choose")}</option>
                      <option value="entry">
                        {t("jobs.form.experiences.entry")}
                      </option>
                      <option value="1-2years">
                        {t("jobs.form.experiences.1-2years")}
                      </option>
                      <option value="3-5years">
                        {t("jobs.form.experiences.3-5years")}
                      </option>
                      <option value="5plus">
                        {t("jobs.form.experiences.5plus")}
                      </option>
                    </select>
                  </div>
                  <div className="sm:col-span-2 lg:col-span-1">
                    ...
                    >
                      ...
                      <option value="fulltime">
                        {t("jobs.form.availabilities.fulltime")}
                      </option>
                      <option value="parttime">
                        {t("jobs.form.availabilities.parttime")}
                      </option>
                      <option value="weekends">
                        {t("jobs.form.availabilities.weekends")}
                      </option>
                      <option value="flexible">
                        {t("jobs.form.availabilities.flexible")}
                      </option>
                    </select>
                  </div>
                </div>
                ...
                <motion.div whileHover={{ scale: 1.02 }} className="relative">
                  ...
                  <div className="bg-gray-50 border-2 border-dashed border-gray-400 hover:border-secondary py-4 sm:py-6 px-3 sm:px-4 text-center transition-all duration-300">
                    ...
                    <p className="text-gray-600 font-medium text-xs sm:text-sm md:text-base">
                      {formData.cv
                        ? formData.cv.name
                        : t("jobs.form.uploadText")}
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      {t("jobs.form.fileTypes")}
                    </p>
                  </div>
                </motion.div>
              </motion.div>
